...
def subcommands(subparser):
    # List of the sub-commands we want to be available for the azure-db-fs
    # command
    ...
    # azure-db-fs configure sub-command options
    ...
    subcommand_parsers['configure'].add_argument(
        ...
        choices=PgVersionOptionAzureDBFS.choices,
        default=PgVersionOptionAzureDBFS.default,
        metavar='<postgres-version>',
        help=PgVersionOptionAzureDBFS.help
    )
    subcommand_parsers['configure'].add_argument(
        '-k', '--ssh-pub-key',
        dest='ssh_pub_key',
    ...
    # azure-db-fs logs sub-command options
    ...
    # azure-db-fs deploy sub-command options
